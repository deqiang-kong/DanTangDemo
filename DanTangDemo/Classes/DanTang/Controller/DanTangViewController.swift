...
class DanTangViewController: BaseViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // 获取首页顶部选择数据
        NetworkTool.shareNetworkTool.loadHomeTopData { (ym_channels) in
    ...
    func setupTitlesView() {
        ...
        arrowButton.backgroundColor = GlobalColor()
