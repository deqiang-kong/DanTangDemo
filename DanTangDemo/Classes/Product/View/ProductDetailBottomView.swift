...
class ProductDetailBottomView: UIView, DetailChoiceButtonViewDegegate, UIWebViewDelegate, UITableViewDataSource {
    ...
    var product: Product? {
        didSet {
            ...
            /// 获取单品详细数据
            NetworkTool.shareNetworkTool.loadProductDetailData(id: product!.id!) { (productDetail) in
            ...
            /// 获取评论数据
            NetworkTool.shareNetworkTool.loadProductDetailComments(id: product!.id!) { (comments) in
